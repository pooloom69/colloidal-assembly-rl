...
# TEST 2: Light ON / OFF
# ---------------------------------------------------------------------
def test_light_on_off(core, on_seconds=2.0):
    """Turn the light (shutter) ON for a few seconds, then OFF."""
    print("\n[TEST 2] Light ON/OFF")
...
if __name__ == "__main__":
    ...
    try:
        # Run one at a time. Comment out any you don't want to run yet.
